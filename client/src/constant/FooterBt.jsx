  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-6">
        ...
        <Link
          to="/"
          className="text-sm md:text-lg font-bold hover:text-yellow-600 transition duration-300"
        >
          Evolve Pvt. Ltd.
        </Link>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 text-xs md:text-sm">
          ...
          <div className="hidden lg:flex flex-col items-center animate-pulse">
            ...
            <span className="text-yellow-400">Outsourcing services</span>
          </div>

          {/* Location */}
          <div className="flex flex-col items-center animate-pulse">
            <span className="font-semibold">Location:</span>
            <span className="text-yellow-400">Balkumari, Lalitpur, Nepal</span>
          </div>

          {/* Contact Number */}
          <div className="flex flex-col items-center animate-pulse">
            <span className="font-semibold">Contact:</span>
            <a href="tel:+9779851174646" className="text-yellow-400">
              +977 9851174646
            </a>
          </div>

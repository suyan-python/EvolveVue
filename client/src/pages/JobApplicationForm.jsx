...
export default function JobApplicationForm()
{
  ...
  return (
    <>
      ...
      <Helmet>
        <title>
          {selectedJob.title} Job Opening | {selectedJob.location} | Evolve Vue Careers
        </title>

        <meta
          name="description"
          content={`${selectedJob.title} position available at Evolve Vue. ${selectedJob.workType} role with shift ${selectedJob.shift}. Apply now for healthcare documentation careers.`}
        />

        <meta
          name="keywords"
          content={`${selectedJob.title}, medical jobs Nepal, healthcare jobs, ${selectedJob.department} jobs, clinical documentation`}
        />

        <link
          rel="canonical"
          href={`https://evolvevue.com.np/application/apply/${selectedJob.id}`}
        />

        {/* Open Graph */}
        <meta property="og:title" content={`${selectedJob.title} | Evolve Vue`} />
        <meta
          property="og:description"
          content={`Apply for ${selectedJob.title} at Evolve Vue. ${selectedJob.workType}, ${selectedJob.location}.`}
        />
        <meta property="og:type" content="article" />

        {/* ✅ Structured Data (FIXED PROPERLY) */}
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "JobPosting",
            title: selectedJob.title,
            description: `${selectedJob.title} role at Evolve Vue`,

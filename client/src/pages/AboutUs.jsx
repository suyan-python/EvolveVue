...
function AboutUs()
{
  return (
    <section className="relative py-16 px-6 overflow-hidden">
      {/* Blured yellow Gradient Background */}
      ...
      <div className="relative max-w-6xl mx-auto text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <motion.div
            className="p-8 rounded-xl shadow-md border-l-8 border-yellow-700 bg-white"
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-700">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h4 className="font-semibold text-yellow-600">Expertise</h4>
              <p>
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h4 className="font-semibold text-yellow-600">Compliance</h4>
              <p>
                Adhering to{" "}
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h4 className="font-semibold text-yellow-600">Global Reach</h4>
              <p>
